...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Cluster → collections migration 2026-08-14 — renamed route, 301 wildcard
      ...
      { source: "/recipes/category/chicken", destination: "/recipes/collections/chicken-dinners-for-two", permanent: true },
      { source: "/recipes/category/chicken-breast-recipes", destination: "/recipes/collections/chicken-dinners-for-two", permanent: true },
      { source: "/recipes/category/chicken-dinner-for-two", destination: "/recipes/collections/chicken-dinners-for-two", permanent: true },
      { source: "/recipes/category/chicken-pot-pie", destination: "/recipes/collections/chicken-dinners-for-two", permanent: true },
      { source: "/recipes/category/herb-chicken", destination: "/recipes/collections/chicken-dinners-for-two", permanent: true },
      { source: "/recipes/category/easy-chicken-dinner", destination: "/recipes/category/easy", permanent: true },
      { source: "/recipes/category/easy-chicken-recipes", destination: "/recipes/collections/chicken-dinners-for-two", permanent: true },
      // 2026-08-08 audit P2-6 — category/one-pan merged into its cluster (pillar).
      // Dependent redirects point straight at the cluster (no 2-hop chains).
      { source: "/recipes/category/one-pan", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/one-pan-meal", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/one-pan-dinner", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/one-pan-pasta", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/one-pot", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/sheet-pan-dinner", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/skillet", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/skillet-meal", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/cast-iron", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/stovetop", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/pan-seared", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/one-pan-chicken", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/one-pan-chicken-dinner", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      ...
      { source: "/recipes/category/chicken-for-two", destination: "/recipes/collections/chicken-dinners-for-two", permanent: true },
      ...
      { source: "/recipes/category/rice-bowl", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/rice-recipe", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      { source: "/recipes/category/stir-fry", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      // rice promoted to canonical 2026-08-06 (5 recipes) — redirect removed
      { source: "/recipes/category/asian", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
      ...
      { source: "/recipes/category/mediterranean-chicken", destination: "/recipes/collections/chicken-dinners-for-two", permanent: true },
      ...
      { source: "/recipes/category/easy-to-make-asian-food-recipes", destination: "/recipes/collections/one-pan-dinners-for-two", permanent: true },
