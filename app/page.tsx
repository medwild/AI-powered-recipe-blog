          ...
          __html: JSON.stringify([
            {
              ...
              url: process.env.NEXT_PUBLIC_SITE_URL || "https://augustcook.com",
              logo: `${process.env.NEXT_PUBLIC_SITE_URL || "https://augustcook.com"}/hero-kitchen.png`,
              sameAs: [
                "https://www.instagram.com/augustcook",
                "https://www.pinterest.com/augustcook",
                "https://www.youtube.com/@augustcook",
              ],
            },
            {
              "@context": "https://schema.org",
              ...
              potentialAction: {
                ...
                target: {
                  "@type": "EntryPoint",
                  urlTemplate: `${process.env.NEXT_PUBLIC_SITE_URL || "https://augustcook.com"}/recettes?q={search_term_string}`,
                },
